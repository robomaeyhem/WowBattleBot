...
public class Pokemon implements Serializable, Cloneable {
    ...
    /**
     * Checks if a move is able to be generated by the Battle Bot.
     *
    ...
    public void assignMoves() {
        ...
        SecureRandom rand = new SecureRandom();
        while (this.getMove1() == null || validMove(this.getMove1())) {
            int index = rand.nextInt(compatableMoves.size());
            this.setMove1(getMove(compatableMoves.get(index)));
        }
        while (this.getMove2() == null || validMove(this.getMove2()) || this.getMove2().equals(this.getMove1())) {
            int index = rand.nextInt(compatableMoves.size());
            this.setMove2(getMove(compatableMoves.get(index)));
        }
        while (this.getMove3() == null || validMove(this.getMove3()) || (this.getMove3().equals(this.getMove1()) || this.getMove3().equals(this.getMove2()))) {
            int index = rand.nextInt(compatableMoves.size());
            this.setMove3(getMove(compatableMoves.get(index)));
        }
        while (this.getMove4() == null || validMove(this.getMove4()) || (this.getMove4().equals(this.getMove1()) || this.getMove4().equals(this.getMove2()) || this.getMove4().equals(this.getMove3()))) {
            int index = rand.nextInt(compatableMoves.size());
